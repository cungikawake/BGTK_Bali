<div class="modal-dialog modal-dialog-centered" role="document">
	<div class="modal-content">
		<div class="modal-header">
			...
			<h5 class="modal-title">LAPORAN [<?php print isset($kode) ? $kode : ""; ?>]</h5>
		</div>
		...
		<?php
			...
			if ($status != "Divalidasi Kepala" && $status != "Ditolak Kepala") {
				$disabled = 'disabled="disabled"';
			}
		?>
		
		<form action="/admin/spi/save_arsip_kepala" method="post" class="form-submit-spi" autocomplete="off">
											...
											?>
													<tr>
														...
														<td class="text-center" style="font-size:18px;">
															...
															<input type="checkbox" name="uraian[<?php print $keyItem; ?>][valid]" value="1" <?php print $checked; ?> disabled="disabled" class="valid-check" />
														</td>
													</tr>
											<?php
													}
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<textarea <?php print $disabled; ?> name="keterangan_kepala" class="form-control" rows="5"><?php print isset($keterangan_kepala) ? $keterangan_kepala : ""; ?></textarea>
								</div>
							</div>
						</div>
					</div>
