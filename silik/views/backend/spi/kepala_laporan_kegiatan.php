			...
			<div class="row">
				<div class="col-md-12">
					<?php
						...
						$this->bootgrid->sortBy("arsip.tgl_laporan_diterima_kepala");
						...
						$columns[] = array(
							...
							"field" => "arsip.status",
							"name" => "Status",
							"format" => "label_laporan_kepala"
						);

						$columns[] = array(
							"id" => "tgl_status",
							"field" => "tgl_laporan_disetujui_kepala",
							"name" => "Tgl Status",
							"format" => "date_laporan_kepala"
						);

						$columns[] = array(
							"id" => "petugas_spi",
							"field" => "petugas_laporan_disetujui_kepala",
							"name" => "Petugas",
							"format" => "petugas_laporan_kepala"
						);
						...
						$addButton = array(
							...
							"modal" => array(
								"view" => "backend/spi/modal_laporan_kegiatan_kepala"
							)
						);
						...
						$editButton = array(
							...
							"modal" => array(
								"view" => "backend/spi/modal_arsip_kepala"
							),
							/*"conditions" => array(
								array(
