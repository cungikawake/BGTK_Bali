...
<tr class="unread">
    ...
    <td>
        <h6 class="mb-1 text-muted"><i class="ti ti-circle-filled text-success f-10 m-r-15"></i><?php print $absen; ?></h6>
        <p class="m-0 text-danger"><i class="ti ti-circle-filled text-success f-10 m-r-15"></i><?php print $terlambat; ?></p>
    </td>
    <td>
        <?php if (!empty($keterangan)) { ?>
        <a href="javascript:;" class="text-warning keterangan-terlambat" title="Keterangan" data-id="<?php print $id; ?>">
