							...
							<div class="col-md-12">
								...
								?>
										<div class="surat-tugas-penugasan">
											<div style="font-size: 14px;"><i class="fas fa-file-pdf"></i> <a href="<?php print base_url("/assets/surat_tugas/".$_SESSION["tahun_anggaran"]."/penugasan/".$surat."?v=".rand()); ?>" target="_blank"><?php print $surat; ?> </a></div>
										</div>
								<?php
									}
								?>
							...
							<div class="form-group">
								<div class="row">
									<div class="col-md-12">
										...
										<textarea rows="2" required <?php print $disablePenugasanMonev; ?> class="form-control tempat-tujuan" placeholder="SMPN 1 Kupang"><?php print $monevGroup1["tempat_tujuan"]; ?></textarea>
									</div>
								</div>
							</div>
							<div class="form-group">
									...
									<div class="penugasan-monev-sec">
										...
										<div class="form-group">
											<div class="row">
												<div class="col-md-12">
													<label>Tempat Tujuan</label>
													<textarea rows="2" required <?php print $disablePenugasanMonev; ?> class="form-control tempat-tujuan" placeholder="SMPN 1 Kupang"><?php print $monevGroup["tempat_tujuan"]; ?></textarea>
												</div>
											</div>
										</div>
										<div class="form-group">
	...
	<div class="penugasan-monev-sec">
		...
		<div class="form-group">
			<div class="row">
				<div class="col-md-12">
					<label>Tempat Tujuan</label>
					<textarea rows="2" required class="form-control tempat-tujuan" placeholder="SMPN 1 Kupang"></textarea>
				</div>
			</div>
		</div>
		<div class="form-group">
