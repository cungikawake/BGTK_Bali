                            ...
                            <div class="modal-body">
								...
								<div id="collapseOneDiri" class="collapse in" aria-labelledby="headingOne" data-parent="#accordion-diri">
									...
									<div class="row">
										...
										<div class="col-md-6">
											<div class="form-group">
												<label>Status PTKP <span class="star-req">*</span></label>
												<select name="ptkp" class="form-control select2" required disabled>
													<option value="">&nbsp;</option>

													<?php
														$options = $this->config->item("status_ptkp");
														$valSelected = isset($ptkp) ? $ptkp : "";

														foreach ($options as $val_ptkp => $status_ptkp) {
															$selected = '';

															if ($valSelected == $val_ptkp) {
																$selected = 'selected="selected"';
															}

															print '<option value="'.$val_ptkp.'" '.$selected.'>'.$status_ptkp.'</option>';
														}
													?>
												</select>
											</div>
                                ...
                                <div id="collapseSatker1" class="collapse in" aria-labelledby="headSatker1" data-parent="#accordion2">
                                    <div class="card-body" style="padding: 10px 0 15px;">
										...
										<?php
											...
											foreach($kegiatan_options as $key => $value){
												if(isset($value['key']) && $value['key'] == 'npsn' && $value['value'] == 1){
													$showNpsn = true;
													break;
												} 
										...
										?>
												<div class="row">
													<div class="col-md-6">
														<div class="form-group">
															<label>Nomor Pokok Sekolah Nasional (NPSN) <span class="star-req">*</span></label>
															<input type="text" name="npsn" class="form-control" value="" required disabled />
														</div>
													</div>
													<div class="col-md-6">
														<div class="form-group">
									...
									if (isset($kegiatan_options) && !empty($kegiatan_options)) {
										foreach($kegiatan_options as $key => $value){
											if(isset($value['key']) && $value['key'] == 'kategori' && $value['value'] != '' ){
												$kategories =  explode(PHP_EOL, $value["value"]);
												break;
											} 
											...
											<div class="card" style="margin-bottom: 10px;">
												<div class="btn btn-info" id="headingOne" style="padding:0; margin:0; text-align: left;">
													<a href="javascript:;" data-toggle="collapse" data-target="#collapseOneKategori" aria-expanded="true" aria-controls="collapseOneKategori" style="color:#fff; text-decoration: none; padding: 10px 15px; display: block;">
														...
														<strong style="font-weight: 700;">Kategori:</strong>
													</a>
												</div>
											</div>
										</div>
                                ...
                                ?>
                                    <hr class="m-b-20" />
                                    <div class="form-group m-b-0">
										<label id="label-checkbox-konfirmasi_paket">Konfirmasi Kehadiran <span class="star-req">*</span></label>
                                        <div class="checkbox checkbox-primary d-inline" style="margin: 0;">
                                            ...
                                            <label for="checkbox-konfirmasi_paket" class="cr">
                                                <span>Saya berkomitmen untuk hadir dan mengikuti kegiatan sesuai jadwal yang telah ditentukan</span>
                                            </label>
                                        </div>
                                    </div>
                                <?php
