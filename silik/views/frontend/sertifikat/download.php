...
<html lang="id">
	...
	<body>
		...
		<div class="wrap-header">
			<div class="wrap-title">
				...
				<div class="title">
					<div class="bgp"><?php echo $_ENV['INSTANSI_DIPA_NAME']; ?></div>
								...
								<div class="col-md-4 col-md-offset-4">
									<form class="form-certificate" action="<?php print base_url("/download/table_sertifikat/"); ?>">
										...
										<div class="form-group form-download">
											...
											<select name="year" class="form-control" style="text-align:center;">
												<?php
													$tk = 2022;
													$df_tk = date("Y");
													...
													foreach (range($tk, $df_tk) as $selYear) {
														$setDef = "";
														if ($selectedYear == $selYear) {
															$setDef = 'selected="selected"';
														}

														print '<option value="'.$selYear.'" '.$setDef.'>'.$selYear.'</option>';
													}
												?>
											</select>
										</div>
	...
	<script src="https://www.google.com/recaptcha/api.js?render=6LfSQ7MqAAAAACDdPtZ4O6rlGlxs482f-V6Z_ezm"></script>
		...
		$(document).ready(function () {
			$(document).on("submit","form.form-certificate",function (e) {
				...
				grecaptcha.ready(function() {
				  grecaptcha.execute('6LfSQ7MqAAAAACDdPtZ4O6rlGlxs482f-V6Z_ezm', {action: 'submit'}).then(function(token) {
