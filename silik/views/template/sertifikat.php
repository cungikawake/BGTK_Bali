...
<style type="text/css">
	...
	.cover {
		height: 100%;
		background: url('<?php print base_url("assets/images/sertifikat/".$year."/".$sertifikat["gambar"]); ?>');
	...
	.page-2 {
		height: 100%;
		background: url('<?php print base_url("assets/images/sertifikat/".$year."/".$sertifikat["gambar_2"]); ?>');
		background-position: center;
		background-repeat: no-repeat;
		background-size: cover;
		position: relative;
...
<div class="cover">
	...
	<div class="nomor-registrasi"><?php print $person["kode"]; ?>/C7.20/Cert/<?php print date("Y", strtotime($kegiatan["tgl_selesai_kegiatan"])); ?></div>
