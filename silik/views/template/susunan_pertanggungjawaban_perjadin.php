...
<ol class="susunan_perjadin">
	...
	<li>Surat Perjalanan Dinas (SPD) - Lembar 2 (yang ada cap) Dari <?php echo $_ENV['APP_NAME']; ?></li>
	<li>Surat Perjalanan Dinas (SPD) - Lembar 2 (yang ada cap) Asli dari Lapangan</li>
	<li>Rincian Biaya Perjalanan Dinas</li>
	<li>Daftar Pengeluaran Riil (Jika Ada - Otomatis dari <?php echo $_ENV['APP_NAME']; ?>)</li>
